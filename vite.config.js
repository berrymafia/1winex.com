  ...
  return {
    ...
    configureServer(server) {
      server.middlewares.use((req, res, next) => {
        ...
        if (url === '/es-mx/') {
          res.statusCode = 301;
          res.setHeader('Location', '/es-mx');
          res.end();
          return;
        }
        if (url === '/es-mx') {
          req.url = '/es-mx/index.html';
          next();
          return;
        }
        if (url === '/es-mx/games' || url === '/es-mx/games/') {
          res.statusCode = 301;
          res.setHeader('Location', '/es-mx/casino');
          res.end();
          return;
        }
        if (url === '/es-mx/sports' || url === '/es-mx/sports/') {
          res.statusCode = 301;
          res.setHeader('Location', '/es-mx/betting');
          res.end();
          return;
        }
        if (url === '/es-mx/mobile' || url === '/es-mx/mobile/') {
          res.statusCode = 301;
          res.setHeader('Location', '/es-mx/app');
          res.end();
          return;
        }
        if (url === '/es/') {
        ...
        if (url === '/hi/games' || url === '/hi/games/') {
          res.statusCode = 301;
          res.setHeader('Location', '/hi/casino');
          res.end();
          return;
        }
        if (url === '/hi/sports' || url === '/hi/sports/') {
          res.statusCode = 301;
          res.setHeader('Location', '/hi/betting');
          res.end();
          return;
        }
        if (url === '/hi/mobile' || url === '/hi/mobile/') {
          res.statusCode = 301;
          res.setHeader('Location', '/hi/app');
          res.end();
          return;
        }
        if (url === '/fil/') {
        ...
        if (url === '/el/') {
          res.statusCode = 301;
          res.setHeader('Location', '/el');
          res.end();
          return;
        }
        if (url === '/el') {
          req.url = '/el/index.html';
          next();
          return;
        }
        if (url === '/el/games' || url === '/el/games/') {
          res.statusCode = 301;
          res.setHeader('Location', '/el/casino');
          res.end();
          return;
        }
        if (url === '/el/sports' || url === '/el/sports/') {
          res.statusCode = 301;
          res.setHeader('Location', '/el/betting');
          res.end();
          return;
        }
        if (url === '/el/mobile' || url === '/el/mobile/') {
          res.statusCode = 301;
          res.setHeader('Location', '/el/app');
          res.end();
          return;
        }
        if (
          ...
          if (existsSync(htmlFile)) {
            ...
            req.url = '/ru/404.html';
            res.statusCode = 404;
          } else if (url.startsWith('/es-mx/')) {
            res.statusCode = 404;
            res.setHeader('Content-Type', 'text/html; charset=utf-8');
            res.end(readFileSync(resolve(__dirname, 'es-mx/404.html'), 'utf8'));
            return;
            ...
            return;
          } else if (url.startsWith('/el/')) {
            res.statusCode = 404;
            res.setHeader('Content-Type', 'text/html; charset=utf-8');
            res.end(readFileSync(resolve(__dirname, 'el/404.html'), 'utf8'));
            return;
          } else {
            req.url = url + '.html';
          }
  ...
  build: {
    rollupOptions: {
      input: {
        ...
        'hi-main': resolve(__dirname, 'hi/index.html'),
        'hi-safety': resolve(__dirname, 'hi/safety.html'),
        'hi-bonuses': resolve(__dirname, 'hi/bonuses.html'),
        'hi-casino': resolve(__dirname, 'hi/casino.html'),
        'hi-aviator': resolve(__dirname, 'hi/aviator.html'),
        'hi-lucky-jet': resolve(__dirname, 'hi/lucky-jet.html'),
        'hi-betting': resolve(__dirname, 'hi/betting.html'),
        'hi-payments': resolve(__dirname, 'hi/payments.html'),
        'hi-crypto-casino': resolve(__dirname, 'hi/crypto-casino.html'),
        'hi-app': resolve(__dirname, 'hi/app.html'),
        ...
        'el-main': resolve(__dirname, 'el/index.html'),
        'el-safety': resolve(__dirname, 'el/safety.html'),
        'el-bonuses': resolve(__dirname, 'el/bonuses.html'),
        'el-casino': resolve(__dirname, 'el/casino.html'),
        'el-aviator': resolve(__dirname, 'el/aviator.html'),
        'el-lucky-jet': resolve(__dirname, 'el/lucky-jet.html'),
        'el-betting': resolve(__dirname, 'el/betting.html'),
        'el-payments': resolve(__dirname, 'el/payments.html'),
        'el-crypto-casino': resolve(__dirname, 'el/crypto-casino.html'),
        'el-app': resolve(__dirname, 'el/app.html'),
        'el-responsible-gambling': resolve(__dirname, 'el/responsible-gambling.html'),
        'el-not-working': resolve(__dirname, 'el/not-working.html'),
        'el-404': resolve(__dirname, 'el/404.html'),
        'es-mx-main': resolve(__dirname, 'es-mx/index.html'),
        'es-mx-safety': resolve(__dirname, 'es-mx/safety.html'),
        'es-mx-bonuses': resolve(__dirname, 'es-mx/bonuses.html'),
        'es-mx-casino': resolve(__dirname, 'es-mx/casino.html'),
        'es-mx-aviator': resolve(__dirname, 'es-mx/aviator.html'),
        'es-mx-lucky-jet': resolve(__dirname, 'es-mx/lucky-jet.html'),
        'es-mx-betting': resolve(__dirname, 'es-mx/betting.html'),
        'es-mx-payments': resolve(__dirname, 'es-mx/payments.html'),
        'es-mx-crypto-casino': resolve(__dirname, 'es-mx/crypto-casino.html'),
        'es-mx-app': resolve(__dirname, 'es-mx/app.html'),
        'es-mx-responsible-gambling': resolve(__dirname, 'es-mx/responsible-gambling.html'),
        'es-mx-not-working': resolve(__dirname, 'es-mx/not-working.html'),
        'es-mx-404': resolve(__dirname, 'es-mx/404.html'),
      },
    },
  },
  appType: 'mpa',
