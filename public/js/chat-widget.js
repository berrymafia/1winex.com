const B="1winex-chat-v2",Q="1winex-chat-theme",Z=/^(localhost|127\.0\.0\.1)$/.test(location.hostname)?"/api/chat":"https://api-chat.net/api/chat",ee="1winex",R="1winex-chat-root";async function te(t,e,o){let n;try{n=await fetch(Z,{method:"POST",headers:{"Content-Type":"application/json",Accept:"text/event-stream"},body:JSON.stringify(t),signal:o})}catch(c){if(c?.name==="AbortError"){e.onDone();return}e.onError("Network error. Please try again.");return}if(!n.ok){let c="Request failed. Please try again.";try{const m=await n.json();m?.error&&(c=m.error)}catch{}e.onError(c);return}if(!n.body){e.onError("Empty response from server.");return}const r=n.body.getReader(),p=new TextDecoder;let s="";try{for(;;){const{done:c,value:m}=await r.read();if(c)break;s+=p.decode(m,{stream:!0});const g=s.split(`
`);s=g.pop()||"";for(const d of g){const f=d.trim();if(!f.startsWith("data:"))continue;const b=f.slice(5).trim();if(b){if(b==="[DONE]"){e.onDone();return}try{const h=JSON.parse(b);h.type==="delta"&&h.delta?e.onDelta(h.delta):h.type==="error"?e.onError(h.error||"Assistant error."):h.type}catch{}}}}e.onDone()}catch(c){if(c?.name==="AbortError"){e.onDone();return}e.onError("Stream interrupted. Please try again.")}}const ae=3500;function re(){const t=document.title||"",e=location.href,n=(document.querySelector("main")||document.querySelector("article")||document.querySelector(".review-content")||document.querySelector(".page-content")||document.body).cloneNode(!0);n.querySelectorAll('script, style, noscript, nav, header, footer, .site-header, .site-footer, [id="1winex-chat-root"], [aria-hidden="true"]').forEach(p=>p.remove());const r=(n.textContent||"").replace(/\s+/g," ").trim().slice(0,ae);return{title:t,url:e,snippet:r}}function oe(t){const e='a[href], button:not([disabled]), textarea:not([disabled]), input:not([disabled]), select:not([disabled]), [tabindex]:not([tabindex="-1"])';function o(){return Array.from(t.querySelectorAll(e)).filter(r=>!r.hasAttribute("disabled")&&r.offsetParent!==null)}function n(r){if(r.key!=="Tab")return;const p=o();if(p.length===0){r.preventDefault();return}const s=p[0],c=p[p.length-1];r.shiftKey?document.activeElement===s&&(r.preventDefault(),c.focus()):document.activeElement===c&&(r.preventDefault(),s.focus())}return{activate(){t.addEventListener("keydown",n),(o()[0]||t).focus()},deactivate(){t.removeEventListener("keydown",n)}}}const ne="modulepreload",ie=function(t,e){return new URL(t,e).href},O={},x=function(e,o,n){let r=Promise.resolve();if(o&&o.length>0){const s=document.getElementsByTagName("link"),c=document.querySelector("meta[property=csp-nonce]"),m=c?.nonce||c?.getAttribute("nonce");r=Promise.allSettled(o.map(g=>{if(g=ie(g,n),g in O)return;O[g]=!0;const d=g.endsWith(".css"),f=d?'[rel="stylesheet"]':"";if(!!n)for(let _=s.length-1;_>=0;_--){const v=s[_];if(v.href===g&&(!d||v.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${g}"]${f}`))return;const h=document.createElement("link");if(h.rel=d?"stylesheet":ne,d||(h.as="script"),h.crossOrigin="",h.href=g,m&&h.setAttribute("nonce",m),document.head.appendChild(h),d)return new Promise((_,v)=>{h.addEventListener("load",_),h.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${g}`)))})}))}function p(s){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=s,window.dispatchEvent(c),!c.defaultPrevented)throw s}return r.then(s=>{for(const c of s||[])c.status==="rejected"&&p(c.reason);return e().catch(p)})};let H=null,N=null,P=null;async function se(){return(await x(()=>import("./chat-widget-core-Cy0t5JvF.js"),[],import.meta.url)).default}async function le(){if(!H||!N){const[t,e]=await Promise.all([x(()=>import("./chat-widget-marked.esm-DweX3G3F.js"),[],import.meta.url),x(()=>import("./chat-widget-purify.es-BnINGy_Y.js"),[],import.meta.url)]);H=t,N=e,t.marked.setOptions({gfm:!0,breaks:!0})}return{marked:H.marked,DOMPurify:N.default}}async function ce(){if(P)return P;const t=await se(),e=await Promise.all([x(()=>import("./chat-widget-javascript-DUNaicwC.js"),[],import.meta.url),x(()=>import("./chat-widget-typescript-5pldp2kO.js"),[],import.meta.url),x(()=>import("./chat-widget-json-DdsocbVI.js"),[],import.meta.url),x(()=>import("./chat-widget-bash-I8pq0VWm.js"),[],import.meta.url),x(()=>import("./chat-widget-xml-FcirFJJ2.js"),[],import.meta.url),x(()=>import("./chat-widget-css-AVCICof-.js"),[],import.meta.url),x(()=>import("./chat-widget-python-C7NRPp2R.js"),[],import.meta.url)]);return["javascript","typescript","json","bash","xml","css","python"].forEach((n,r)=>t.registerLanguage(n,e[r].default)),P=t,t}const j={ALLOWED_TAGS:["p","br","strong","em","u","s","code","pre","blockquote","ul","ol","li","a","h1","h2","h3","h4","table","thead","tbody","tr","th","td","hr","span","button","div"],ALLOWED_ATTR:["href","title","target","rel","class","data-lang","type","aria-label"]},de="nofollow noopener noreferrer",pe=new Set(["1winex.com","www.1winex.com"]);function G(t){return!(!t||t.startsWith("#")||/^(mailto|tel|javascript|data):/i.test(t))}function ue(t){try{const e=typeof location<"u"?location.href:"https://1winex.com/",o=new URL(t,e).pathname.replace(/\/+$/,"")||"/";return o==="/go"||o==="/apk"}catch{return!1}}function ge(t){const e=t.trim();if(!G(e)||ue(e))return!1;if(!/^https?:\/\//i.test(e)&&!e.startsWith("//"))return!/^[a-z][a-z0-9+.-]*:/i.test(e);try{const o=e.startsWith("//")?`https:${e}`:e,n=new URL(o).hostname.toLowerCase();if(pe.has(n)||typeof location<"u"&&location.hostname&&n===location.hostname.toLowerCase())return!0}catch{return!1}return!1}function V(t){t.querySelectorAll("a[href]").forEach(e=>{const o=e,n=(o.getAttribute("href")||"").trim();if(!G(n))return;const r=/^https?:\/\//i.test(n)||n.startsWith("//"),p=!r&&!/^[a-z][a-z0-9+.-]*:/i.test(n);if(!(!r&&!p)){if(ge(n)){o.removeAttribute("target"),o.removeAttribute("rel");return}o.setAttribute("target","_blank"),o.setAttribute("rel",de)}})}function me(t){const e=document.createElement("div");return e.innerHTML=t,V(e),e.innerHTML}async function he(t){const{marked:e,DOMPurify:o}=await le(),n=await e.parse(t||"");let r=o.sanitize(String(n),j);if(/<pre[\s>]/i.test(r)){const p=await ce(),s=document.createElement("div");s.innerHTML=r,s.querySelectorAll("pre code").forEach(c=>{const m=c,d=(m.className||"").match(/language-([\w-]+)/)?.[1];try{d&&p.getLanguage(d)?m.innerHTML=p.highlight(m.textContent||"",{language:d}).value:m.innerHTML=p.highlightAuto(m.textContent||"").value}catch{}const f=m.parentElement;if(f&&f.tagName==="PRE"&&!f.querySelector(".aw-code-copy")){f.setAttribute("data-lang",d||"code");const b=document.createElement("button");b.type="button",b.className="aw-code-copy",b.setAttribute("aria-label","Copy code"),b.textContent="Copy",f.appendChild(b)}}),r=o.sanitize(s.innerHTML,j)}return me(r)}function U(){try{const t=localStorage.getItem(B);if(!t)return null;const e=JSON.parse(t);return!e||!Array.isArray(e.messages)?null:e}catch{return null}}function we(t){try{localStorage.setItem(B,JSON.stringify(t))}catch{}}function fe(){const t=U();return t?t.messages.slice(-60):[]}function be(){return!!U()?.unread}function _e(t,e=!1){we({messages:t.slice(-60),updatedAt:Date.now(),unread:!!e})}function ve(){try{const t=localStorage.getItem(Q);if(t==="light"||t==="dark")return t}catch{}return"dark"}const xe=["What license does 1win have?","How does the 600% bonus work?","How fast are withdrawals?","Does 1win have a mobile app?"];function y(t,e=4){const o=[],n=new Set;for(const r of t){const p=String(r||"").replace(/\s+/g," ").trim();if(!p)continue;const s=p.toLowerCase();if(!n.has(s)&&(n.add(s),o.push(p),o.length>=e))break}return o}function ye(t=location.pathname){const e=t.replace(/\/+$/,"")||"/";if(e==="/"||e==="/index"||e==="/index.html")return"index";const o=e.split("/").filter(Boolean);return o.length?o[0].replace(/\.html$/i,""):"index"}function Ee(t=typeof location<"u"?location.pathname:"/"){const e=ye(t);return y(e==="bonuses"?["How does the 600% bonus work?","What are the wagering requirements?","Where do I enter WINEX600?","How do I claim the welcome package?"]:e==="payments"?["How fast are withdrawals?","Does 1win support crypto?","What is the minimum withdrawal?","How long does KYC take?"]:e==="mobile"?["How do I install the Android APK?","Is there an iOS app?","Can I play in the mobile browser?","Does 1win have a mobile app?"]:e==="games"?["What slots does 1win have?","What is Aviator RTP?","Does 1win have live casino?","How does the 600% bonus work?"]:e==="sports"?["How do I place a 1win sports bet?","Can I cash out a sports bet?","What is Express booster?","Do casino and sports bonuses share a balance?"]:e==="safety"?["What license does 1win have?","How long does KYC take?","Is my money safe at 1win?","Does 1win have 2FA?"]:e==="faq"?["How do I register at 1win?","How fast are withdrawals?","How does the 600% bonus work?","Does 1win have a mobile app?"]:e==="responsible-gambling"?["What responsible gambling tools does 1win offer?","How do I set a deposit limit?","How does self-exclusion work?","What license does 1win have?"]:[...xe])}const ke=`
.aw-chat {
...
`;function Ae(){if(document.getElementById("1winex-chat-styles"))return;const t=document.createElement("style");t.id="1winex-chat-styles",t.textContent=ke,document.head.appendChild(t)}function z(){return`m_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,8)}`}function Se(t){try{return new Intl.DateTimeFormat(void 0,{hour:"numeric",minute:"2-digit"}).format(new Date(t))}catch{return""}}const W={chat:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',close:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" aria-hidden="true"><path d="M18 6 6 18M6 6l12 12"/></svg>'},Le=new URL("../images/chat/anna.webp?v=3",import.meta.url).href;function $(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Te(){if(document.getElementById(R))return;Ae();let t=fe(),e=!1,o=null,n=null;const r=document.createElement("div");r.id=R,r.className="aw-chat",r.dataset.theme=ve(),r.setAttribute("data-nosnippet",""),r.innerHTML=`
  ...
  `,document.body.appendChild(r);const p=r.querySelector(".aw-chat__panel");p.id="aw-chat-panel";const s=r.querySelector(".aw-chat__messages"),c=r.querySelector(".aw-chat__composer"),m=c.querySelector("textarea"),g=c.querySelector(".aw-chat__send"),d=r.querySelector(".aw-chat__toggle"),f=d.querySelector(".aw-chat__badge"),b=oe(p);let h=null;const _=new Map;let v=0,A=be();function E(){_e(t.filter(a=>a.status!=="streaming"),A)}function Y(a){s.querySelector(`[data-id="${a}"]`)?.scrollIntoView({block:"start",behavior:"smooth"})}function T(){const a=A&&!e;r.classList.toggle("has-unread",a),f.hidden=!a,f.setAttribute("aria-hidden",a?"false":"true"),e?d.setAttribute("aria-label","Close chat with Anna"):a?d.setAttribute("aria-label","Open chat with Anna — new message"):d.setAttribute("aria-label","Open chat with Anna")}function C(){e||(A=!0,E(),T())}function S(a){e=a,r.classList.toggle("is-open",e),d.setAttribute("aria-expanded",String(e)),p.hidden=!e,p.setAttribute("aria-hidden",e?"false":"true"),e?(A=!1,E(),h=document.activeElement,b.activate()):(b.deactivate(),(h||d).focus()),T()}async function L(a,i){const u=(_.get(a.id)??0)+1;_.set(a.id,u);let w=i;w||(w=document.createElement("div"),w.className=`aw-msg aw-msg--${a.role}`,w.dataset.id=a.id,s.appendChild(w));const l=document.createElement("div");if(l.className="aw-msg__bubble",a.role==="assistant")if(a.status==="streaming"&&!a.content)l.innerHTML='<span class="aw-typing" aria-label="Anna is typing"><i></i><i></i><i></i></span>';else try{const M=await he(a.content||"");if(_.get(a.id)!==u)return;l.innerHTML=M,V(l)}catch{if(_.get(a.id)!==u)return;l.textContent=a.content||""}else l.textContent=a.content;if(_.get(a.id)!==u)return;const k=document.createElement("div");k.className="aw-msg__meta",k.textContent=Se(a.createdAt),w.replaceChildren(l,k)}async function F(a){const i=s.scrollTop;if(s.replaceChildren(),t.length===0){const u=document.createElement("div");u.className="aw-chat__empty";const w=Ee().map(l=>`<button type="button" class="aw-chat__suggest" data-suggest="${$(l)}">${$(l)}</button>`).join("");u.innerHTML=`
