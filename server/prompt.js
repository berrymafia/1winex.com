...
function bonusLinkRules() {
  return [
    ...
    'The only 1win promo code 1winex publishes is 1WINEX500. Write it in full. Do not invent other codes, coupons, or seasonal tokens.',
    'The 500% welcome attaches when the visitor taps Add promo code at registration and enters 1WINEX500.',
    'Whenever the user asks about a bonus, promo, promo code, welcome bonus, free spins offer, or how to claim / activate / get a bonus — you MUST include [Claim Welcome Bonus](https://bonus-999.com/1win) and the code 1WINEX500.',
    'If they specifically ask for a promo code / промокод / coupon, lead with 1WINEX500, say to tap Add promo code at registration and enter it — then the claim link.',
